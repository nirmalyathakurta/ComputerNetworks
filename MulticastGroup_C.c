...
{
	int val = -1;
	struct sockaddr_in address2, address4;
	char buffer[1024] = {0};
	...
	pthread_create(&pt[1], NULL, receive_g2, NULL);
	//pthread_create(&pt[3], NULL, receive_g3, NULL);
	pthread_create(&pt[2], NULL, receive_g4, NULL);
